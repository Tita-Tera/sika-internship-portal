            ...
            <table className="w-full min-w-[700px]">
              <thead className="bg-zinc-950">
                <tr className="border-b border-zinc-800">
                  <th className="text-left p-4 md:p-6 font-medium text-zinc-400">
                    Applicant
                  </th>
                  <th className="text-left p-4 md:p-6 font-medium text-zinc-400 hidden md:table-cell">
                    Email
                  </th>
                  <th className="text-left p-4 md:p-6 font-medium text-zinc-400">
                    Date
              ...
              <tbody>
                {applications.map((app) => (
                  <tr
                    key={app.id}
                    className="border-b border-zinc-800 hover:bg-zinc-800/60 transition-all"
                  >
                    <td className="p-4 md:p-6 font-medium text-white whitespace-nowrap">
                      {app.full_name}
                    </td>
                    <td className="p-4 md:p-6 text-zinc-400 hidden md:table-cell break-all">
                      {app.email}
                    </td>
            ...
            <div className="bg-zinc-900 w-full max-w-4xl rounded-3xl border border-zinc-700 max-h-[95vh] flex flex-col overflow-hidden">
              ...
              <div className="flex items-center justify-between p-6 border-b border-zinc-800 bg-zinc-950">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-blue-600 flex items-center justify-center text-3xl">
                    👤
                  </div>
                  <div>
              ...
              <div className="flex-1 overflow-auto p-6 space-y-10">
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6 bg-zinc-950 p-6 rounded-2xl">
                    {Object.entries(selectedApp.about || {}).map(
                      ([key, value]) => (
                        <div key={key}>
                ...
                <section>
                  ...
                  <div className="bg-zinc-950 p-6 rounded-2xl space-y-6">
                    {Object.entries(selectedApp.education || {}).map(
                      ([key, value]) => (
                        <div
                          key={key}
                          className="flex flex-col sm:flex-row sm:justify-between gap-1 border-b border-zinc-800 pb-4 last:border-0"
                        >
                ...
                <section>
                  ...
                  <div className="bg-zinc-950 p-6 rounded-2xl space-y-6">
                    {Object.entries(selectedApp.internship || {}).map(
                      ([key, value]) => (
                        <div
                          key={key}
                          className="flex flex-col sm:flex-row sm:justify-between gap-1 border-b border-zinc-800 pb-4 last:border-0"
                  ...
                  <div className="bg-zinc-950 p-6 md:p-8 rounded-2xl">
                    {selectedApp.uploads ? (
                      <div className="space-y-8">
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 gap-4">
                            {Object.entries(selectedApp.uploads).map(
                              ([key, value]) => {
                                if (key === "socialLinks") return null;
                                return (
                                  <div
                                    key={key}
                                    className="flex flex-col sm:flex-row sm:items-center justify-between bg-zinc-900 p-5 rounded-2xl gap-3"
                                  >
                        ...
                        {selectedApp.uploads.socialLinks &&
                          Object.values(selectedApp.uploads.socialLinks).some(
                            (v) => Boolean(v),
                          ) && (
                            <div>
                                ...
                                {Object.entries(
                                  ...
                                  return (
                                    <a
                                      ...
                                      target="_blank"
                                      rel="noreferrer"
                                      className="block text-blue-400 hover:underline text-sm break-all"
                                    >
                      ...
                      <p className="text-zinc-500">
                        No documents or links provided.
                      </p>
                    )}
